...
if __name__=="__main__":
    ...
    plt.scatter(imgep["core2_exec_time"],imgep["core1_exec_time"], marker = ">",label="imgep")
    plt.scatter(random_exploration["core2_exec_time"],random_exploration["core1_exec_time"], label="random exploration", marker = "<", alpha = .7)
    #plt.scatter(random_exploration["core2_exec_time"],random_exploration["core1_exec_time"], label="random exploration",alpha = .7)
